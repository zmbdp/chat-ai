...
[![License](https://img.shields.io/github/license/zmbdp/chat-ai)](LICENSE)
[![Stars](https://img.shields.io/github/stars/zmbdp/chat-ai)](https://github.com/zmbdp/chat-ai/stargazers)
...
**chat-ai** 是我在多个项目中反复使用的一套基于 **Spring Boot 3.x + Spring Cloud 2023** 的 **微服务工程脚手架（Scaffold）**。
...
chat-ai 本身并不是一个可以直接上线使用的后台系统，这一点在一开始用的时候就刻意控制住了。
...
chat-ai 集成了 **20 多个常用工具类**，涵盖复杂泛型BeanCopy、加密、JSON、Excel、邮件、分页、流处理等功能。  
...
#### 1. 克隆项目
```bash
git clone https://github.com/zmbdp/chat-ai.git
cd chat-ai
```
...
```bash
cd deploy/dev/app
docker compose -p chat-ai -f docker-compose-mid.yml up -d
```
...
- 📚 **项目地址**: [https://github.com/zmbdp/chat-ai](https://github.com/zmbdp/chat-ai)
...
<table>
  <tr>
    <td align="center">
      <b>功能概述</b><br>
      <img src="https://framework-java-web.oss-cn-shanghai.aliyuncs.com/chat-ai/%E5%8A%9F%E8%83%BD%E6%A6%82%E8%BF%B0.PNG" style="max-width: 100%; height: auto;">
    </td>
    <td align="center">
      <b>系统架构</b><br>
      <img src="https://framework-java-web.oss-cn-shanghai.aliyuncs.com/chat-ai/%E7%B3%BB%E7%BB%9F%E6%9E%B6%E6%9E%84%E9%A1%B5%E9%9D%A2.png" style="max-width: 100%; height: auto;">
    </td>
  </tr>
  <tr>
    <td align="center">
      <b>使用手册</b><br>
      <img src="https://framework-java-web.oss-cn-shanghai.aliyuncs.com/chat-ai/%E4%BD%BF%E7%94%A8%E6%89%8B%E5%86%8C%E6%88%AA%E5%9B%BE.png" style="max-width: 100%; height: auto;">
    </td>
    <td align="center">
      <b>API文档</b><br>
      <img src="https://framework-java-web.oss-cn-shanghai.aliyuncs.com/chat-ai/API%E6%96%87%E6%A1%A3%E6%88%AA%E5%9B%BE.png" style="max-width: 100%; height: auto;">
    </td>
  </tr>
  <tr>
    <td align="center">
      <b>SDK文档</b><br>
      <img src="https://framework-java-web.oss-cn-shanghai.aliyuncs.com/chat-ai/SDK%E6%88%AA%E5%9B%BE.png" style="max-width: 100%; height: auto;">
    </td>
    <td align="center">
      <b>管理端登录页</b><br>
      <img src="https://framework-java-web.oss-cn-shanghai.aliyuncs.com/chat-ai/%E7%99%BB%E5%BD%95%E9%A1%B5.png" style="max-width: 100%; height: auto;">
    </td>
  </tr>
  <tr>
    <td align="center">
      <b>管理端管理页</b><br>
      <img src="https://framework-java-web.oss-cn-shanghai.aliyuncs.com/chat-ai/%E7%94%A8%E6%88%B7%E7%AE%A1%E7%90%86%E9%A1%B5.png" style="max-width: 100%; height: auto;">
    </td>
    <td align="center">
      <b>字典管理页</b><br>
      <img src="https://framework-java-web.oss-cn-shanghai.aliyuncs.com/chat-ai/%E5%AD%97%E5%85%B8%E8%AE%BE%E7%BD%AE%E9%A1%B5.png" style="max-width: 100%; height: auto;">
    </td>
  </tr>
</table>
...
**chat-ai只负责打基础，真正的业务复杂度，还是应该由你自己的项目来承载。**
