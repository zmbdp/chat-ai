-- SkyWalking 数据库初始化脚本
-- 创建数据库
CREATE DATABASE IF NOT EXISTS `chat-ai_skywalking_dev` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

USE `chat-ai_skywalking_dev`;

-- 授权
GRANT ALL PRIVILEGES ON chat-ai_skywalking_dev.* TO 'zmbdpdev'@'%';
FLUSH PRIVILEGES;
